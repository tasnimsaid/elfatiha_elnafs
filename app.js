...
document.getElementById("laa2").innerHTML=Counter2*29282;

document.getElementById("haa").innerHTML=Counter3;
document.getElementById("haa3").innerHTML=Counter3*43923;

document.getElementById("mim").innerHTML=Counter4;
document.getElementById("mim4").innerHTML=Counter4*58564;

document.getElementById("dal").innerHTML=Counter5;
document.getElementById("dal5").innerHTML=Counter5*73205;

document.getElementById("haae").innerHTML=Counter6;
document.getElementById("haae6").innerHTML=Counter6*87846;

document.getElementById("raa").innerHTML=Counter7;
document.getElementById("raa7").innerHTML=Counter7*102487;

document.getElementById("baa").innerHTML=Counter8;
document.getElementById("baa8").innerHTML=Counter8*117128;

document.getElementById("ine").innerHTML=Counter9;
document.getElementById("ine9").innerHTML=Counter9*131769;
...
document.getElementById("noon11").innerHTML=Counter11*161051;

document.getElementById("kaf").innerHTML=Counter12;
document.getElementById("kaf12").innerHTML=Counter12*175692;


document.getElementById("ouaou").innerHTML=Counter13;
document.getElementById("ouaou13").innerHTML=Counter13*190333;


document.getElementById("sin").innerHTML=Counter14;
document.getElementById("sin14").innerHTML=Counter14*204974;

document.getElementById("taa").innerHTML=Counter15;
document.getElementById("taa15").innerHTML=Counter15*219615;

document.getElementById("saad").innerHTML=Counter16;
document.getElementById("saad16").innerHTML=Counter16*234256;

document.getElementById("ttae").innerHTML=Counter17;
document.getElementById("ttae17").innerHTML=Counter17*248897;

document.getElementById("ppaf").innerHTML=Counter18;
document.getElementById("ppaf18").innerHTML=Counter18*263538;


document.getElementById("ddal").innerHTML=Counter19;
document.getElementById("ddal19").innerHTML=Counter19*278179;

document.getElementById("gaa").innerHTML=Counter20;
document.getElementById("gaa20").innerHTML=Counter20*292820;

document.getElementById("daa").innerHTML=Counter21;
document.getElementById("daa21").innerHTML=Counter21*307461;

document.getElementById("faa").innerHTML=Counter22;
document.getElementById("faa22").innerHTML=Counter22*322102;

document.getElementById("zay").innerHTML=Counter23;
document.getElementById("zay23").innerHTML=Counter23*336743;

document.getElementById("kha").innerHTML=Counter24;
document.getElementById("kha24").innerHTML=Counter24*351384;

document.getElementById("chine").innerHTML=Counter25;
document.getElementById("chine25").innerHTML=Counter25*366025;

document.getElementById("ddda").innerHTML=Counter26;
document.getElementById("ddda26").innerHTML=Counter26*380666;

document.getElementById("jim").innerHTML=Counter27;
document.getElementById("jim27").innerHTML=Counter27*395307;

document.getElementById("ttta").innerHTML=Counter28;
document.getElementById("ttta28").innerHTML=Counter28*409948;
...
document.getElementById("best3").innerHTML= Counter1*14641 + Counter2*29282 + Counter3*43923 + Counter4*58564 + Counter5*73205 + Counter6*87846 + Counter7*102487 + Counter8*117128 + Counter9*131769 + Counter10*146410 + Counter11*161051 + Counter12*175692 + Counter13*190333 + Counter14*204974 + Counter15*219615 + Counter16*234256 + Counter17*248897 + Counter18*263538 + Counter19*278179 + Counter20*292820 + Counter21*307461 + Counter22*322102 + Counter23*336743 + Counter24*351384 + Counter25*366025 + Counter26*380666 + Counter27*395307 + Counter28*409948  ;
...
var
  ...
  document.getElementById("core3").innerHTML= roma * 8000 ;      
  document.getElementById("core").innerHTML= (roma * 8000)+1 ;      
  document.getElementById("core1").innerHTML= (roma * 8000)-1 ;      
  document.getElementById("core2").innerHTML= (roma * 8000)+2 ;      
  document.getElementById("core4").innerHTML= (roma * 8000)+3 ;      
  ...
  document.getElementById("kon1").innerHTML= (kaoune * 31417)+1 ;      
  document.getElementById("kon4").innerHTML= (kaoune * 31417)-1 ;      
  document.getElementById("kon2").innerHTML= (kaoune * 31417)+2 ;      
  document.getElementById("kon3").innerHTML= (kaoune * 31417)+3 ;      
